...
export default async function page({
  ...
  return (
    <div className='grid grid-cols-10 gap-5 p-5'>
        <AttendanceLeft user = {currentUser||null} classes = {classes} data1 = {data1} data2 = {data2}/>
        <AttendanceRight user = {currentUser||null} students={students} data1 = {data1} data2 = {data2}/>
    </div>
  )
}
